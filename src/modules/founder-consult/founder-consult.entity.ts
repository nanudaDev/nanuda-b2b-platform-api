...
@Entity({ name: 'FOUNDER_CONSULT' })
export class FounderConsult extends BaseEntity<FounderConsult> {
  @PrimaryGeneratedColumn({
    type: 'int',
    name: 'NO',
    unsigned: true,
  ...
  @OneToMany(
    type => FounderConsultManagement,
    founderConsultManagement => founderConsultManagement.founderConsult,
  )
  founderConsultManagements?: FounderConsultManagement[];
}
